...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    public class ObjectSpawner : MonoBehaviour
    {
        ...
        {
            // Добавляем проверку на максимальное количество объектов перед созданием нового объекта.
            if (m_ObjectPrefabs.Count >= m_MaxSpawnCount)
            {
                return false;
            }
            ...
            // После успешного спауна объекта увеличиваем счётчик объектов.
            m_ObjectPrefabs.Add(newObject);
